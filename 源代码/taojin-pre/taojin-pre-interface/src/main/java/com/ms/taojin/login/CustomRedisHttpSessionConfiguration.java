...
/**
 * Exposes the {@link SessionRepositoryFilter} as a bean named "springSessionRepositoryFilter". In order to use this a
 * single {@link RedisConnectionFactory} must be exposed as a Bean.
 *
 * @author Rob Winch
 * @since 1.0
 *
...
@Configuration
@EnableScheduling
public class CustomRedisHttpSessionConfiguration extends SpringHttpSessionConfiguration implements ImportAware {
	 ...
	 *            the configureRedis to set. The default is {@link ConfigureNotifyKeyspaceEventsAction}.
	 */
