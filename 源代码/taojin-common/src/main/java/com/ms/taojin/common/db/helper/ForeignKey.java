 ...
 *
 */
@SuppressWarnings({"serial","unused", "rawtypes","deprecation"})
...
//		try {
//			foreignTable = (Table) TableFactory.getInstance().getTableForCenter(tableName);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
	...
	public Table getSqlTable() {
		Table table = null;
//		try {
//			table = (Table) TableFactory.getInstance().getTableForCenter(tableName);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
		return table;
