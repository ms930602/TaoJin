...
public class GameService extends BaseService {
	 ...
	 */
	public BaseRespVO queryHave(GameEntity reqVO) throws CenterException {
		GameEntity query = gameBo.queryByEntity(reqVO);
		if(query != null && query.getId() > 0){
			return new BaseRespVO(2,"该游戏已存在！");
		}
	...
	public Object queryById(@Param("id") Long id) throws CenterException {
		SessionUser user = ThreadContext.getSessionloginUser();
		GameEntity query = new GameEntity();
		query.setId(id);
