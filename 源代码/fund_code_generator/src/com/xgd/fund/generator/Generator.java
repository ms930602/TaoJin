...
import com.xgd.fund.generator.util.AntPathMatcher;
import com.xgd.fund.generator.util.BeanHelper;
import com.xgd.fund.generator.util.FileHelper;
import com.xgd.fund.generator.util.FreemarkerHelper;
import com.xgd.fund.generator.util.GLogger;
import com.xgd.fund.generator.util.GeneratorException;
import com.xgd.fund.generator.util.IOHelper;
	...
	private class TemplateProcessor {
		...
		private void executeGenerate(File templateRootDir, Map templateModel, Map filePathModel, File srcFile)
			...
			if (isCopyBinaryFile && FileHelper.isBinaryFile(srcFile)) {
				...
				IOHelper.copyAndClose(new FileInputStream(srcFile), new FileOutputStream(new File(getOutRootDir(),
				        outputFilepath)));
				return;
			}
		...
		private void processTemplateForGeneratorControl(Map templateModel, String templateFile) throws IOException,
		        TemplateException {
