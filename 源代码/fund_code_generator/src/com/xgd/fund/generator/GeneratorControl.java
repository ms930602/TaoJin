...
import com.xgd.fund.generator.util.SqlExecutorHelper;
import com.xgd.fund.generator.util.StringHelper;
import com.xgd.fund.generator.util.SystemHelper;
...
public class GeneratorControl {
    ...
    public GeneratorControl() {
	    super();
	    isOverride = Boolean.parseBoolean(getProperty("gg.isOverride","false"));
    }
	/** load xml data */
	public NodeModel loadXml(String file) {
		NodeModel loadXml = loadXml(file,true);
		return loadXml;		
	}	
	/** load xml data */
