...
public class PreSellEntity extends BaseEntity {
	...
	public String toString() {
		return new StringBuilder().append("PreSellEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof PreSellEntity == false)
			return false;
		if(this == obj)
			return true;
		PreSellEntity other = (PreSellEntity)obj;
